...
Point::Point(double tempx, double tempy)        //the constructor for the Point variable with two double parameters as x and y coordinates
{
	x=tempx;
	y=tempy;
}
...
{  //assignment operator for the Point variable
