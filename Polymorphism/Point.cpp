...
{
	x=tempx;                       // constructor with two double parameters, first as the x-coordinate, second as the y-coordinate
	y=tempy;
}
...
Point& Point::operator = (const Point& source)
{
	...
	if (this == &source)                     //assignment operator for Point variable
