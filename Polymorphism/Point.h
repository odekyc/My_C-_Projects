...
private:
	...
	friend ostream& operator << (ostream& os, Point p);    //<< operator for Point class
public:
	// Constructors
	Point();								// Default constructor
    Point(Point&source);              //copy constructor
	Point(double tempx, double tempy);		 //constructor with two double number parameters, first as the x-coordinate and second as the y-coordinate, respectively
