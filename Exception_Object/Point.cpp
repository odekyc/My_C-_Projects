...
double Point:: Distance(Point&p2)         //find the distance between this point passed in the arguement and the current point
{
	...
	return sqrt( resultx+resulty);       //find the squareroots of the sum of resultx and resulty
